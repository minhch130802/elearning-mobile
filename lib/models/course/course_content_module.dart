...
class CourseContentModule {
  ...
  List<CourseModuleContent>? contents;

  CourseContentModule.fromJSON(Map<String, dynamic> json){
    this.id = json['id'];
    this.name = json['name'];
  ...
  List<CourseModuleContent> parseModuleContentList(json) {
    List<CourseModuleContent> data = [];

    for(int i = 0; i < json.length; i++) {
      data.add(new CourseModuleContent.fromJSON(json[i]));
    }
