...
import '/interfaces/pages/course/course_enroll_page.dart';
import '/interfaces/pages/course/course_enrolled_participants_page.dart';
import '/interfaces/themes/master.dart';
import '/interfaces/widgets/bottom_sheet_items.dart';
import '/interfaces/widgets/section_items.dart';
...
class _CourseContentPageState extends State<CourseContentPage> {
  ...
  void _getCourseContent() async {
    ...
    await _contentAPI.getCourseContent(widget.courseId).then((value) {
      if (value != []) {
        setState(() {
          _courseContentList.addAll(value);
        });
      }
      print(_courseContentList.length);
    }).whenComplete(() {
      setState(() {
        _isLoading = false;
      });
